...
trait oAuth
{
     ...
     */
    // p("!!!");
    // private $mastodon_api_url = MASTODON_INSTANCE;
    ...
    private $credentials = array(
        "client_id"     => MASTODON_CONSUMER_KEY,
        "client_secret" => MASTODON_CONSUMER_SECRET,
        "bearer"        => MASTODON_BEARER
    );
    ...
    public function getApiURL(){
        // p("GETAPIURL".$this->mastodon_api_url);
