...
class ConfigurationVO
{
     ...
     * @var string
     */
    const DEFAULT_INSTANCE = 'awscommunity.social';
     ...
     * @var string
     */
    const DEFAULT_REDIRECT_URIS = 'https://barredo.work/mastofeed/login';
     ...
     * @var string
     */
    const DEFAULT_WEBSITE = 'https://barredo.work/mastofeed/';
    ...
    public function __construct($client_name = self::DEFAULT_NAME, $mastodon_instance = self::DEFAULT_INSTANCE)
    {
        ...
        $this->setScopes(['read','write','follow']);
